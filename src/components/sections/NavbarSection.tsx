    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.1] text-foreground mb-5 sm:mb-6 animate-fade-in-up delay-100">
            Готовьте уроки{" "}
